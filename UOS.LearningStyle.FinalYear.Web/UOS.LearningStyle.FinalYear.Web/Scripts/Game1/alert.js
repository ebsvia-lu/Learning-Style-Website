    ...
    !function e(t, n, o) {
        ...
        1: [function (o, a, r) {
            ...
            var l, i, u, c, d = o("./modules/handle-dom"), f = o("./modules/utils"), p = o("./modules/handle-swal-dom"),
                m = o("./modules/handle-click"), v = s(o("./modules/handle-key")), y = s(o("./modules/default-params")),
            ...
            r.default = u = c = function () {
                ...
                switch (typeof a) {
                    ...
                    case "object":
                        ...
                        r.title = a.title;
                        for (var s in y.default) r[s] = o(s);
                        r.confirmButtonText = r.showCancelButton ? "Confirm" : y.default.confirmButtonText, r.confirmButtonText = o("confirmButtonText"), r.doneFunction = arguments[1] || null;
                        break;
                    default:
                        return (0, f.logStr)('Unexpected type of argument! Expected "string" or "object", got ' + typeof a), !1
                }
                (0, b.default)(r), (0, p.fixVerticalPosition)(), (0, p.openModal)(arguments[1]);
                for (var u = (0, p.getModal)(), h = u.querySelectorAll("button"), g = ["onclick", "onmouseover", "onmouseout", "onmousedown", "onmouseup", "onfocus"], w = function (e) {
                    return (0, m.handleButton)(e, r, u)
                }, C = 0; C < h.length; C++) for (var S = 0; S < g.length; S++) {
                    var x = g[S];
                    h[C][x] = w
                }
                (0, p.getOverlay)().onclick = w, l = e.onkeydown;
                e.onkeydown = function (e) {
                    return (0, v.default)(e, r, u)
                }, e.onfocus = function () {
                    setTimeout(function () {
                        i !== n && (i.focus(), i = n)
                    }, 0)
            ...
            var a = t("./utils"), r = (t("./handle-swal-dom"), t("./handle-dom")), s = function (e, t) {
                var n = !0;
                (0, r.hasClass)(e, "show-input") && ((n = e.querySelector("input").value) || (n = "")), t.doneFunction(n), t.closeOnConfirm && sweetAlert.close(), t.showLoaderOnConfirm && sweetAlert.disableButtons()
            }, l = function (e, t) {
            ...
            o.default = {
                handleButton: function (t, n, o) {
                    ...
                    var u, c, d, f = t || e.event, p = f.target || f.srcElement,
                        m = -1 !== p.className.indexOf("confirm"), v = -1 !== p.className.indexOf("overlay"),
            ...
            a.hasClass = r, a.addClass = function (e, t) {
                r(e, t) || (e.className += " " + t)
            ...
            }, a._show = s, a.show = function (e) {
                if (e && !e.length) return s(e);
                for (var t = 0; t < e.length; ++t) s(e[t])
            }, a._hide = l, a.hide = function (e) {
            ...
            }, a.stopEventPropagation = function (t) {
            ...
            a.default = function (t, o, a) {
                ...
                if (-1 !== [9, 13, 32, 27].indexOf(i)) {
                    ...
                    9 === i ? (f = -1 === p ? u : p === d.length - 1 ? d[0] : d[p + 1], (0, r.stopEventPropagation)(l), f.focus(), o.confirmButtonColor && (0, s.setFocusStyle)(f, o.confirmButtonColor)) : 13 === i ? ("INPUT" === f.tagName && (f = u, u.focus()), f = -1 === p ? u : n) : 27 === i && !0 === o.allowEscapeKey ? (f = c, (0, r.fireClick)(f, l)) : f = n
                }
            }, o.exports = a.default
            ...
            Object.defineProperty(a, "__esModule", { value: !0 });
            var s = n("./utils"), l = n("./handle-dom"), i = r(n("./default-params")), u = r(n("./injected-html")),
                c = function () {
                    var e = t.createElement("div");
                    for (e.innerHTML = u.default; e.firstChild;) t.body.appendChild(e.firstChild)
                }, d = function e() {
                    var n = t.querySelector(".alert");
                    return n || (c(), n = e()), n
                }, f = function () {
                    var e = d();
                    return e ? e.querySelector("input") : void 0
                }, p = function () {
                    return t.querySelector(".overlay")
                }, m = function (e) {
                    if (e && 13 === e.keyCode) return !1;
                    var t = d(), n = t.querySelector(".sa-input-error");
            ...
            a.sweetAlertInitialize = c, a.getModal = d, a.getOverlay = p, a.getInput = f, a.setFocusStyle = function (e, t) {
                ...
                var o = d();
                (0, l.fadeIn)(p(), 10), (0, l.show)(o), (0, l.addClass)(o, "showSweetAlert"), (0, l.removeClass)(o, "hideSweetAlert"), e.previousActiveElement = t.activeElement, o.querySelector("button.confirm").focus(), setTimeout(function () {
                ...
                if ("null" !== a && "" !== a) {
                    ...
                    o.timeout = setTimeout(function () {
                        (r || null) && "true" === o.getAttribute("data-has-done-function") ? r(null) : sweetAlert.close()
                    }, a)
                }
            }, a.resetInput = function () {
                var e = d(), t = f();
                (0, l.removeClass)(e, "show-input"), t.value = i.default.inputValue, t.setAttribute("type", i.default.inputType), t.setAttribute("placeholder", i.default.inputPlaceholder), m()
            }, a.resetInputError = m, a.fixVerticalPosition = function () {
                d().style.marginTop = (0, l.getTopMargin)(d())
            }
        }, { "./default-params": 2, "./handle-dom": 4, "./injected-html": 7, "./utils": 9 }], 7: [function (e, t, n) {
            Object.defineProperty(n, "__esModule", { value: !0 });
            n.default = '<div class="overlay" tabIndex="-1"></div><div class="alert"><div class="sa-icon sa-error">\n      <span class="sa-x-mark">\n        <span class="sa-line sa-left"></span>\n        <span class="sa-line sa-right"></span>\n      </span>\n    </div><div class="sa-icon sa-warning">\n      <span class="sa-body"></span>\n      <span class="sa-dot"></span>\n    </div><div class="sa-icon sa-info"></div><div class="sa-icon sa-success">\n      <span class="sa-line sa-tip"></span>\n      <span class="sa-line sa-long"></span>\n\n      <div class="sa-placeholder"></div>\n      <div class="sa-fix"></div>\n    </div><div class="sa-icon sa-custom"></div><h2>Title</h2>\n    <p>Text</p>\n    <fieldset>\n      <input type="text" tabIndex="3" />\n      <div class="sa-input-error"></div>\n    </fieldset><div class="err">\n      <div class="icon">!</div>\n      <p>Not valid!</p>\n    </div><div class="sa-button-container">\n      <button class="cancel" tabIndex="2">Cancel</button>\n      <div class="sa-confirm-button-container">\n        <button class="confirm" tabIndex="1">OK</button><div class="la-ball-fall">\n          <div></div>\n          <div></div>\n          <div></div>\n        </div>\n      </div>\n    </div></div>', t.exports = n.default
        }, {}], 8: [function (e, t, o) {
            Object.defineProperty(o, "__esModule", { value: !0 });
            ...
            o.default = function (e) {
                ...
                if ((0, s.hide)(t.querySelectorAll(".sa-icon")), e.type && !(0, a.isIE8)()) {
                    var f = function () {
                        ...
                        var i = n;
                        -1 !== ["success", "error", "warning", "info"].indexOf(e.type) && (i = t.querySelector(".sa-icon.sa-" + e.type), (0, s.show)(i));
                        var u = (0, r.getInput)();
                        switch (e.type) {
                            case "success":
                                (0, s.addClass)(i, "animate"), (0, s.addClass)(i.querySelector(".sa-tip"), "animateSuccessTip"), (0, s.addClass)(i.querySelector(".sa-long"), "animateSuccessLong");
                                break;
                            case "error":
                                (0, s.addClass)(i, "animateErrorIcon"), (0, s.addClass)(i.querySelector(".sa-x-mark"), "animateXMark");
                                break;
                            case "warning":
                                (0, s.addClass)(i, "pulseWarning"), (0, s.addClass)(i.querySelector(".sa-body"), "pulseWarningIns"), (0, s.addClass)(i.querySelector(".sa-dot"), "pulseWarningIns");
                                break;
                            case "input":
                            case "prompt":
                                u.setAttribute("type", e.inputType), u.value = e.inputValue, u.setAttribute("placeholder", e.inputPlaceholder), (0, s.addClass)(t, "show-input"), setTimeout(function () {
